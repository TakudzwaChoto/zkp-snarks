...
- Generate large datasets to improve accuracy/precision/recall:
  - JSON: `python data/generate_dataset.py -b 25000 -a 25000 -f json -o data/50kdata.json`
  - CSV: `python data/generate_dataset.py -b 100000 -a 100000 -f csv -o data/200kdata.csv`
